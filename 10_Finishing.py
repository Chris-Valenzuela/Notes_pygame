...
class player(object):
    ...
    def hit(self):
        # reset the jump so that you wont end up under the goblin when u collide in air
        self.isJump = False
        self.jumpCount = 10 
        self.x = 60
        self.y = 410
...
while run:
    ...
    # makes sure goblin doesnt walk around invisible 
    if goblin.visible ==  True:
        ...
        if man.hitbox[1] < goblin.hitbox[1] + goblin.hitbox[3] and man.hitbox[1] + man.hitbox[3] > goblin.hitbox[1]:
            if man.hitbox[0] + man.hitbox[2] > goblin.hitbox[0] and man.hitbox[0]  < goblin.hitbox[0] + goblin.hitbox[2]:
                man.hit()
                score -= 5 
    # if goblin is not visible wait 1 second and respawn a new enmey  
    else:
        font2 = pygame.font.SysFont('comincsans', 50)
        text2 = font2.render('New Goblin Appearing!', 1, (255, 0, 0))
        win.blit(text2, (screenWidth/2 - text2.get_width()/2, screenLength/2 - text2.get_height()/2))
        pygame.display.update()
        i = 0 
        while i < 100:
            # in ms so 10 ms * 300 
    ...
    # Todo  you can hold right and click and left and ull get left. BUT u cant hold left click right and go right
